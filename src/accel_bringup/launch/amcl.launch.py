...
# This launch file utilizes AMCL to navigate
...
def generate_launch_description():
    ...
    map_file_arg = DeclareLaunchArgument(
        "map_file",
        default_value=PathJoinSubstitution([FindPackageShare("accel_bringup"), "maps", "map.yaml"]),
    ...
    amcl_params_file_arg = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [FindPackageShare("accel_bringup"), "config", "amcl.yaml"]
        ),
